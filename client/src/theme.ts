...
export const THEMES: Record<ThemeKey, Theme> = {
  ...
  light: {
    ...
    card:        'bg-white/70 backdrop-blur-sm border border-black/10 rounded-2xl shadow-sm',
    cardActive:  'bg-white/80 backdrop-blur-sm border border-black/80 ring-1 ring-black/20 rounded-2xl shadow-sm',
    btn:         'bg-white hover:bg-gray-50 border border-black/15 transition text-gray-900 shadow-sm',
    btnAccent:   'bg-gray-950 hover:bg-gray-800 border border-black transition text-white shadow-sm',
    btnDanger:   'bg-white hover:bg-rose-50 border border-black/15 transition text-rose-600 shadow-sm',
    btnDisabled: 'bg-white border border-black/10 opacity-40 cursor-not-allowed text-gray-900',
    input:       'bg-white border border-black/20 text-gray-950 placeholder-gray-400 focus:border-black focus:outline-none shadow-sm',
    text:        'text-gray-950',
    ...
    borderDanger: 'border-rose-200',
    beat:        'bg-white border border-black/10 text-gray-400 shadow-sm',
    beatActive:  'bg-gray-200 border border-black/20 ring-1 ring-black/30 scale-105 text-gray-900',
    beatAccent:  'bg-gray-950 ring-2 ring-black/50 scale-110 text-white',
    stepOff:     'bg-white border border-black/10 shadow-sm',
    stepCurrent: 'ring-2 ring-black',
    beatGridCurrent: 'bg-gray-950',
    beatGridFilled:  'bg-gray-300 border border-black/10',
    beatGridBar:     'bg-white/60 backdrop-blur-sm border border-black/10',
    beatGridEmpty:   'bg-white border border-black/8',
    navActive:   'text-gray-950',
    navInactive: 'text-gray-400 hover:text-gray-700',
    navBg:       'bg-white/70 backdrop-blur-sm border-t border-black/10',
    playBtn:      'bg-gray-950 hover:bg-gray-800 border border-black shadow-md text-white',
    stopBtn:      'bg-white hover:bg-gray-50 border border-black/20 shadow-md text-gray-950',
