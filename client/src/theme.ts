...
export const THEMES: Record<ThemeKey, Theme> = {
  purple: {
    ...
    btnAccent:   'bg-violet-600 hover:bg-violet-500 transition text-white',
    btnDanger:   'bg-rose-600 hover:bg-rose-500 transition text-white',
    ...
    playBtn:      'bg-violet-600 hover:bg-violet-500 shadow-lg shadow-violet-900/50 text-white',
    stopBtn:      'bg-rose-600 hover:bg-rose-500 shadow-lg shadow-rose-900/50 text-white',
