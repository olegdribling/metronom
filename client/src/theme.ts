...
export const THEMES: Record<ThemeKey, Theme> = {
  ...
  light: {
    _name: 'Light',
    page:        'bg-gray-100 text-gray-950',
    card:        'bg-white/70 backdrop-blur-sm border border-black/30 rounded-2xl shadow-sm',
    cardActive:  'bg-white/80 backdrop-blur-sm border-2 border-black ring-1 ring-black/20 rounded-2xl shadow-sm',
    btn:         'bg-white hover:bg-gray-50 border border-black/40 transition text-gray-950 font-medium shadow-sm',
    btnAccent:   'bg-gray-950 hover:bg-gray-800 border border-black transition text-white font-medium shadow-sm',
    btnDanger:   'bg-white hover:bg-rose-50 border border-black/40 transition text-rose-700 font-medium shadow-sm',
    btnDisabled: 'bg-white border border-black/20 opacity-40 cursor-not-allowed text-gray-950',
    input:       'bg-white border border-black/40 text-gray-950 placeholder-gray-500 focus:border-black focus:outline-none shadow-sm',
    text:        'text-gray-950',
    textSub:     'text-gray-600',
    textMuted:   'text-gray-500',
    textAccent:  'text-gray-950',
    textDanger:  'text-rose-700',
    border:       'border-black/30',
    borderStrong: 'border-black/50',
    borderAccent: 'border-black',
    borderDanger: 'border-rose-300',
    beat:        'bg-white border border-black/30 text-gray-500 font-semibold shadow-sm',
    beatActive:  'bg-gray-200 border border-black/50 ring-1 ring-black/40 scale-105 text-gray-950 font-bold',
    beatAccent:  'bg-gray-950 ring-2 ring-black scale-110 text-white font-bold',
    stepOff:     'bg-white border border-black/30 shadow-sm',
    stepCurrent: 'ring-2 ring-black',
    beatGridCurrent: 'bg-gray-950',
    beatGridFilled:  'bg-gray-400 border border-black/20',
    beatGridBar:     'bg-white/60 backdrop-blur-sm border border-black/30',
    beatGridEmpty:   'bg-white border border-black/15',
    navActive:   'text-gray-950 font-semibold',
    navInactive: 'text-gray-500 hover:text-gray-800',
    navBg:       'bg-white/70 backdrop-blur-sm border-t border-black/20',
    playBtn:      'bg-gray-950 hover:bg-gray-800 border border-black shadow-md text-white',
    stopBtn:      'bg-white hover:bg-gray-50 border border-black/40 shadow-md text-gray-950',
    sliderAccent: 'accent-gray-950',
    instruments: { bd: '#111827', sd: '#374151', hh: '#6b7280' },
    preview: ['bg-gray-100', 'bg-white', 'bg-gray-950', 'bg-gray-300'],
  },
